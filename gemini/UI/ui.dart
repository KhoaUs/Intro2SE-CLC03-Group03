...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _sendChatMessage(String message) async {
    ...
    try {
      ...
      if (response != null) {
        setState(() {
          _generatedContent.add((image: null, text: response, fromUser: false));
        });
      }
    } catch (e) {
  ...
  Future<void> _sendImagePrompt(String message) async {
    ...
    try {
      ...
      if (pickedFile != null) {
        ...
        // Add the selected image to the chat UI
        setState(() {
          _generatedContent.add(
            (image: Image.memory(imageData), text: message, fromUser: true),
          );
        });
        _scrollDown();

        // Send the image and message prompt to the chat service
        final response =
            await _chatService.sendImagePrompt(_textController.text, pickedFile);
